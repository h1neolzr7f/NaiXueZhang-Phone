...
当前发布：**1.5.2-phone.22**（`versionCode` 173）  
电脑版基准：v1.5.2  
...
直链（约 72 小时有效）：https://litter.catbox.moe/ie1vr6.apk

|项目|值|
|---|---|
|文件|`NaiXueZhang-Phone-1.5.2.apk`|
|大小|约 51MB|
|版本|1.5.2-phone.22 / versionCode 173|
|SHA256|`08abf4816f2f0bd150d787f2111c6256f571e8a23c8cc95334b5d4de3cf0d7f4`|
|包名|`com.naixuezhang.studio.mobile`|
...
私人开发仓 `NaiXueZhang-Studio-Phone` 的代码已升到 phone.22；`cursor[bot]` 不能直接推公开源码仓的 main，完整源码同步需你本机 `git push`。
